...
sudo apt-get install scrot ImageMagick compton i3blocks feh rofi i3lock i3status thunar terminator -y
...
#sudo apt-get install terminator	#terminal of choice.
